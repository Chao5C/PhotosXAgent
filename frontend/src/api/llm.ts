...
export const llmApi = {
  ...
  testProvider: (name: string) => ApiClient.post(`/api/llm/providers/${name}/test`, {}, { timeout: 180000 }),
  listOllamaLocal: () => ApiClient.get('/api/llm/providers/ollama/local-models'),
  syncOllama: () => ApiClient.post('/api/llm/providers/ollama/sync', {}, { timeout: 30000 }),
  ...
  testModel: (provider: string, model: string) =>
    ApiClient.post(`/api/llm/models/${provider}/${encodeURIComponent(model)}/test`, {}, { timeout: 180000 }),
